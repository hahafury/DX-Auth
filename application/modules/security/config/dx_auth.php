...
// URI Locations
$config['DX_logout_uri'] = 'security/Auth/logout/';
$config['DX_register_uri'] = 'security/Auth/register/';
$config['DX_forgot_password_uri'] = 'security/Auth/forgot_password/';
$config['DX_change_password_uri'] = 'security/Auth/change_password/';
$config['DX_cancel_account_uri'] = 'security/Auth/cancel_account/';

// Forms view
$config['DX_login_view'] = 'security/Auth/login_form';
$config['DX_register_view'] = 'security/Auth/register_form';
$config['DX_forgot_password_view'] = 'security/Auth/forgot_password_form';
$config['DX_change_password_view'] = 'security/Auth/change_password_form';
$config['DX_cancel_account_view'] = 'security/Auth/cancel_account_form';

// Pages view
$config['DX_deny_view'] = 'security/Auth/general_message';
$config['DX_banned_view'] = 'security/Auth/general_message';
$config['DX_logged_in_view'] = 'security/Auth/general_message';
$config['DX_logout_view'] = 'security/Auth/general_message';

$config['DX_register_success_view'] = 'security/Auth/general_message';
$config['DX_activate_success_view'] = 'security/Auth/general_message';
$config['DX_forgot_password_success_view'] = 'security/Auth/general_message';
$config['DX_reset_password_success_view'] = 'security/Auth/general_message';
$config['DX_change_password_success_view'] = 'security/Auth/general_message';

$config['DX_register_disabled_view'] = 'security/Auth/general_message';
$config['DX_activate_failed_view'] = 'security/Auth/general_message';
$config['DX_reset_password_failed_view'] = 'security/Auth/general_message';
